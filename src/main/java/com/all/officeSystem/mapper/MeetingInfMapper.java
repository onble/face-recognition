...
public interface MeetingInfMapper {
    ...
    @Select("SELECT meeting.title,meeting.address,meeting.content,meeting.meeting_id,meeting.meeting_id,meeting.start_time,meeting.stop_time,meeting.`status` FROM meeting")
