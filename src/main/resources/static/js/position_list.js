...
function reder_date(data) {
    ...
    <tr>
        <td>
            <input type="checkbox" value="${value["id"]}" name="post_id" />
        </td>
        <td>${value["name"]}</td>
        <td>${value["duty"]}</td>
        ...
        <td class="td-manage">
            <a
                title="编辑"
                href="javascript:;"
                onclick="post_edit('编辑','position_edit.html','${value["id"]}','1000','450')"
                class="ml-5"
            ...
            <a
                title="删除"
                href="javascript:;"
                onclick="post_del(this,'${value["id"]}')"
                style="text-decoration: none"
            >
                <i class="layui-icon">&#xe640;</i>
            </a>
