...
public class DepartmentServiceImpl implements DepartmentService {
   ...
   private DepartmentService departmentService;
    ...
    @Override
    public R getDepartmentByPage(int page, int items) throws Exception {
        // 初始化分页信息
        PageHelper.startPage(int page, int items);
        // 查询全部数据
        List<Department> department = departmentMapper.selectAll();
        // 借助分页助手获取分页信息
        PageInfo<Department> pageInfo = new PageInfo<>(deparment);
